...
class IsAtendente implements ValidationRule
{
    /**
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if ($funcionario->cargo_id !== CargoEnum::ATENDENTE->value) {
            $fail('O funcionário informado não possui o cargo de Atendente.');
